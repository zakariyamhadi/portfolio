...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border items-center border-slate-900/[0.2] dark:bg-slate-900 dark:border-white/[0.2] bg-white shadow-input flex justify-center space-x-4 px-8 py-6 "
    >
      {children}
    </nav>
  );
